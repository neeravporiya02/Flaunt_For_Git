            ...
            <div id="demo" className="carousel slide" data-bs-ride="carousel">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src="http://webpage.pace.edu/np57411n/cs641/Project1/Flaunt/assets/images/banner2.png" alt="Bath and Body" className="d-block w-100" />
                    </div>
                    <div className="carousel-item">
                        <img src="http://webpage.pace.edu/np57411n/cs641/Project1/Flaunt/assets/images/banner5.jpg" alt="Black Fox" className="d-block w-100" />
                    </div>
                    <div className="carousel-item">
                        <img src="http://webpage.pace.edu/np57411n/cs641/Project1/Flaunt/assets/images/banner4.jpg" alt="Axe" className="d-block w-100" />
                    </div>
                </div>
